function [p_ym_L, p_ymmin_L, p_nu_L, p_den_L, d_ln_L, d_wd_L, d_ht_L, d_FE_L, vole_L,...
    nodx_L, nody_L, nodz_L, nelx_L, nely_L, nelz_L, tot_elements_L,dmin_L, dmax_L, pen_L, ac_L, vol_frac_L, initial_v_L, name_run_L, beta_L, q_L, tens_limit_L, comp_limit_L, max_u_L, loadcase_1_L, av_L, name_excel_L] = F_data_gh()
%Reading data
name_excel_L = 'Data_setup_full.xlsx';
sheet_name = 'Data';
[d_FE, Length, Width, Height] = f_read_data_gh(name_excel_L, sheet_name);
...
d_ann_L = ann_thickness(max_anneal_T_L, p_den_L, p_nu_L, p_ym_L);
...
initial_v_L = 0.3;              % Initial volume fraction
...
name_run_L = '231020_case_CMPL_obj_ALL_con_point_supports';
name_folder = 'Results\';
